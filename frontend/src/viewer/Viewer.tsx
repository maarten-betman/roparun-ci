...
export function Viewer({ apiKey, publicPath }: ViewerProps) {
  ...
  useEffect(() => {
    ...
    // Standard "show my location" control on the map canvas — MapLibre's
    // built-in does the permission dance, accuracy circle, and recenter
    // button. Pure client-side; nothing leaves the browser.
    map.addControl(
